...
<head>
  ...
  <style>
    :root { --primary-color: #00684A; --border-color: #e5e7eb; --text-color: #111; }
...
<body>
  <div class="container">
    ...
    <div class="card">
      ...
      <p>This MCP Client is requesting authorization to manage MongoDB through <strong>${serverName}</strong>. If you approve, you will be redirected to sign in.</p>
